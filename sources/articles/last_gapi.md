...
tools like RenderDoc cant show you register pressure, where pipeline stalls occur, saturation
...
<small>i already love this</small>
...
Synchronization:
In my tests, "full memory read / write" barriers were not any different in performance from precise ones. We could go further: "offensive" sync, where barriers are "full read/write" unless specified (again, faster prototyping, later refining, which is what you usually do in Vulkan anyways)
...
Subgroup operations would become more common if everyone agrees on warp sizes. Currently its a pain to write cross-platform.
